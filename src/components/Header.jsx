  ...
  return (
    <div>
      <header className="bg-[#fff] mb-[-1px]  relative">
        ...
        <div className="flex n-container py-20  items-center justify-between  px-[10px]">
          ...
          <div className="flex items-center gap-4 w-full max-w-[70%]">
                ...
                <g>
                  <g>
                    <path
                      ...
                      d="M352.1,270.4c-10,0-17.7,6.3-20.8,13.8c-2.4,5.8-2.5,12.7,0.3,18.4
                        c3.5,7.3,11.5,13.1,21.7,13.1c4.5,0,8.8-1.2,12.7-3.4c2.8-1.7,3.8-5.4,2.1-8.3c-1.7-2.8-5.4-3.9-8.2-2.1c-5.7,3.1-13,2.2-16.9-3.7
                        h23.5c5,0,8.6-2.7,8.1-8C373.1,278.9,363.5,270.4,352.1,270.4z M343,288.1c0.8-3.4,4.6-6.5,9-6.5c4.5,0,8.2,3.2,9,6.5H343z"
                    />
                    <path
                      className="st0"
            ...
            {/* Search Bar */}
            <div className="flex border relative border-orange-400 rounded-full  w-full max-w-md">
            ...
            <div className="flex items-center justify-between h-11 pr-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <div
                  className={`relative ${
                    !isHome ? "group" : ""
                  } border-y-5 rounded-md border-orange-500`}
                >
