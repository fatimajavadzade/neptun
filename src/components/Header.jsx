    ...
    <div>
      <header className="bg-[#fff] n-container relative" >
        ...
        <div className="flex items-center justify-between py-[15px] px-[10px]">
          {/* Logo */}
          <Link to={"/"} className="text-orange-500 text-2xl font-bold w-40">
            <svg
          ...
          {/* Search Bar */}
          <div className="flex border border-orange-400 rounded-full overflow-hidden w-full max-w-md ml-4">
            ...
            />
            <Button label="Axtar" className="px-4 py-1 text-sm bg-orange-400 hover:bg-orange-500" />
          </div>
          <div className="flex items-center space-x-4">
            {/* Bayraq və 162 - sadəcə lg və yuxarı */}
            ...
            {/* Hamburger Menü - sadəcə lg altı (mobile/tablet) */}
