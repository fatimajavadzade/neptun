    ...
    <header className="bg-[#fff] n-container relative">
      ...
      <div className="flex items-center justify-between py-[15px] px-[10px]">
          ...
          <div className="flex items-center gap-4 w-full max-w-[70%]">
              ...
              >
                <g>
                  <g>
                    ...
                    />
                    <path className="st0" d="M404.3,270.1c-4,0-7.8,1.1-11.1,2.8c-1.2-1.3-2.9-2.1-5-2.1c-3.6,0-6.6,3-6.6,6.6v44.8
                    ...
                    <path className="st0" d="M455.3,283.1c3.5,0,6.2-2.7,6.2-6.1c0-3.5-2.7-6.2-6.2-6.2h-6.5v-7c0-3.9-3.2-7.1-7.1-7.1
                        s-7.1,3.2-7.1,7.1v32.7c0,10.3,7.4,18.5,17.9,18.5h1.3c3.9,0,7.1-3.2,7.1-7.1s-3.2-7.1-7.1-7.1h-1.3c-2.6,0-3.7-2.1-3.7-4.3
                        v-13.5H455.3z"></path>
                    <path className="st0" d="M501.2,270.8c-3.9,0-7,3.2-7,7v18.4c0,3-2.5,5.5-5.5,5.5c-3,0-5.5-2.5-5.5-5.5v-18.4c0-3.8-3.1-7-7-7
                    ...
                    <path className="st0" d="M536.7,270.8c-10.8,0-19.6,8.8-19.6,19.6v18.4c0,3.8,3.1,7,7.1,7c3.9,0,7-3.2,7-7v-18.4
                        ...
                        "></path>
                    <path className="st0" d="M303.4,270.8c-4.4,0-8.5,1.5-11.8,4c-3-2.6-6.9-4.1-11.4-4.1h-1.3c-3.8,0-7,3.1-7,7c0,3.8,3.1,7,7,7h1.3
                    ...
                    <circle className="st0" cx="290.9" cy="328.9" r="7"></circle>
                    <circle className="st0" cx="315.9" cy="328.9" r="7"></circle>
                  </g>
                </g>
                <g>
                  <g>
                    <path className="st0" d="M437.2,330.1c0.9,0,1.7,0.4,2.2,1.1c0.6,0.7,0.8,1.6,0.6,2.5c-0.1,0.7-0.5,1.2-1,1.7
                    ...
                    <path className="st0" d="M446.7,335c-0.5-0.6-0.8-1.3-0.8-2v-6.4c0-0.2,0.1-0.3,0.2-0.5c0.1-0.1,0.3-0.2,0.5-0.2
                    ...
                    <path className="st0" d="M460.5,326c0.7,0,1.3,0.3,1.8,0.8c0.5,0.5,0.8,1.1,0.8,1.8v0c0,0.7-0.3,1.3-0.8,1.8
                    ...
                    <path className="st0" d="M473.1,334.7c0.2,0,0.3,0.1,0.4,0.2c0.1,0.1,0.2,0.3,0.2,0.5c0,0.2-0.1,0.3-0.2,0.5
                    ...
                    <path className="st0" d="M485.1,328.6c0,0.8-0.3,1.4-0.9,1.9c0.6,0.5,0.9,1.2,0.9,1.9v2.8c0,0.2-0.1,0.3-0.2,0.5
                    ...
                    <path className="st0" d="M498,325.9c0.2,0,0.3,0.1,0.5,0.2c0.1,0.1,0.2,0.3,0.2,0.5v8.7c0,0.2-0.1,0.3-0.2,0.5
                    ...
                    <path className="st0" d="M510,327.7c0.1,0.3,0.1,0.5,0.1,0.8v6.8c0,0.2-0.1,0.3-0.2,0.5c-0.1,0.1-0.3,0.2-0.5,0.2s-0.3-0.1-0.5-0.2
                    ...
                    <path className="st0" d="M521.7,328.6c0,0.8-0.3,1.4-0.9,1.9c0.6,0.5,0.9,1.2,0.9,1.9v2.8c0,0.2-0.1,0.3-0.2,0.5
                      c-0.1,0.1-0.3,0.2-0.5,0.2s-0.3-0.1-0.4-0.2c-0.1-0.1-0.2-0.3-0.2-0.5v-2.8c0-0.4-0.1-0.7-0.4-0.9c-0.3-0.3-0.6-0.4-0.9-0.4h-1.5
                      v4.1c0,0.2-0.1,0.3-0.2,0.5c-0.1,0.1-0.3,0.2-0.5,0.2c-0.2,0-0.3-0.1-0.5-0.2c-0.1-0.1-0.2-0.3-0.2-0.5v-8.7
                      ...
                      c0.4,0,0.7-0.1,0.9-0.4c0.3-0.3,0.4-0.6,0.4-0.9v0c0-0.4-0.1-0.7-0.4-0.9c-0.3-0.3-0.6-0.4-0.9-0.4h-1.5V330z"></path>
                    <path className="st0" d="M533,335c0.1,0.1,0.1,0.3,0.1,0.5c0,0.2-0.1,0.3-0.2,0.4c-0.1,0.1-0.3,0.1-0.5,0.1c-0.2,0-0.3-0.1-0.4-0.3
                    ...
                    <path className="st0" d="M543.2,334.7c0.2,0,0.3,0.1,0.5,0.2c0.1,0.1,0.2,0.3,0.2,0.5c0,0.2-0.1,0.3-0.2,0.5
                    ...
                    <path className="st0" d="M554.7,326c0.2,0,0.3,0.1,0.5,0.2c0.1,0.1,0.2,0.3,0.2,0.5c0,0.2-0.1,0.3-0.2,0.5c-0.1,0.1-0.3,0.2-0.5,0.2
            ...
            {/* Search Bar */}
            <div className="flex border border-orange-400 rounded-full overflow-hidden w-full max-w-md">
        ...
        <div className="flex items-center justify-between h-11 pr-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-white">
              <span className="cursor-pointer hover:underline">Ana səhifə</span>
              <span className="cursor-pointer hover:underline">Haqqımızda</span>
              <span className="cursor-pointer hover:underline">Aksiyalar</span>
              <span className="cursor-pointer hover:underline">Supermarketlər</span>
              <span className="cursor-pointer hover:underline">Karyera</span>
