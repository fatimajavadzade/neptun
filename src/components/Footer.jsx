...
function Footer() {
  return (
    ...
    <div className="bg-primary w-full  p-[25px]">
     ...
     <p className="text-white text-[14px] font-bold mx-3 me-5">© 2003 - 2023 Neptun Supermarket. All rights reserved</p>
     <div className="flex items-center my-5">
     <p className="text-white text-[14px] font-bold mx-3 me-5">Created by:</p> <a href="#"><img className="h-[21px] w-[60px" src="https://neptun.az/image/catalog/footer/amiroff_creative_agency.png" alt="" /></a></div>
    </div>
    </div>
